...
import React, { useState, useEffect } from "react";
import { Menu, Plus, X, UserX, Loader2 } from "lucide-react";
import Sidebar from "../HospitalSidebar";
import { Card } from "@/components/ui/card";
import axios from "axios";
import AddDoctor from "./AddDoctor";
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className={mainContentClass}>
        ...
        {/* Desktop Header */}
        <div className="bg-white border-b sticky top-0 z-10 hidden md:block">
        ...
        <div className="p-4 sm:p-6">
          {showAddDoctor ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 text-center">
              ...
              <p className="text-gray-500 max-w-md">
                There are currently no doctors registered in the organization.
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
